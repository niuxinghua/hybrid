...
- (void)showContent
{
    [HaierH5ViewController showContentWithAPPName:@"hwork" navigationMode:NO fullScreenMode:YES animated:YES titleName:@"hwork" rootController:self pageName:@"demo.html"];
}
